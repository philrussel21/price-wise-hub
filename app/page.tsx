	...
	return (
		<Region className="!mt-10">
			<Container className="grid grid-cols-4 grid-rows-4 gap-7">
				<div className="min-h-44 rounded-2xl bg-black text-white">
				...
				<div className="min-h-44 row-span-2 rounded-2xl bg-black text-white">Content</div>
				<div className="min-h-44 row-span-2 rounded-2xl overflow-hidden relative">
					<ProductCarousel products={products}/>
				</div>
				<div className="min-h-44 col-span-2 row-span-2 rounded-2xl flex flex-col justify-center items-center p-8 gap-y-6 bg-black text-white">
				...
				<div className="min-h-44 row-span-2 rounded-2xl overflow-hidden">
					<ProductCarousel products={products}/>
				</div>
				<div className="min-h-44 col-span-2 rounded-2xl bg-black text-white">footer content</div>
				<div className="min-h-44 rounded-2xl bg-black text-white">Supported stores</div>
			</Container>
		</Region>
	);
};
